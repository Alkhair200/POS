        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title" style="margin-bottom: 15px">@lang('site.categories') {{--<small>Quick Exapm</small>--}}</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="panel-group">
                                ...
                                <div class="panel panel-info" style="text-color: black-darck" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href=""
                                                                   ...
                                                                   class="btn {{in_array($product->id , $order->products->pluck('id')->toArray()) ? 'btn-default disabled' : 'btn-success'}}">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title" style="margin-bottom: 15px">@lang('site.orders') {{--<small>Quick Exapm</small>--}}</h3>
                        </div> <!----End box of header----->
                    ...
                    <form action="{{route('dashboard.clients.orders.update',['client' => $client->id , 'order' => $order->id])}}" method="post">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody class="order-list">
                                ...
                                <tr>
                                    <td>{{$product->name}}</td>
                                    <td><input type="number" name="products[{{$product->id}}][quantity]" data-price="{{number_format($product->sale_price)}}" class="form-control input-sm product-quantity" min="1" value="{{$product->pivot->quantity}}"></td>
                        ...
                        <h4>@lang('site.total') : <span class="total-price">{{number_format($product->sale_price , 2)}}</span></h4>
